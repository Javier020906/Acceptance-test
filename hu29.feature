Feature: Capacidad de filtrado de lugares seguros para infantes
    Como bañista recreativo,
    Quiero poder activar un filtro de lugares seguros para infantes,
    Para minimizar los riesgos y garantizar la seguridad de los menores.
